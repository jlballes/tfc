 ...
 */
class CuponEstablecimiento extends \MisCupones\CuponBundle\Entity\CuponEstablecimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'cupon', 'establecimiento');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CuponEstablecimiento $proxy) {
