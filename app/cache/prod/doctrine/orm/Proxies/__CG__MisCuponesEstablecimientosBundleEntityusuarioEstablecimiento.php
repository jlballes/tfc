 ...
 */
class usuarioEstablecimiento extends \MisCupones\EstablecimientosBundle\Entity\usuarioEstablecimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'establecimiento', 'usuario');
        }
