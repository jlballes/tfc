...
namespace Proxies\__CG__\MisCupones\ComprasBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Compra extends \MisCupones\ComprasBundle\Entity\Compra implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fecha_compra', 'fecha_canjeo', 'codigo', 'canjeado', 'cupon', 'establecimiento', 'usuario');
        }
