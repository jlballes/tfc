...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'misCuponesDB', 'user' => 'misCuponesUser', 'password' => 'misCuponesPass', 'charset' => 'UTF8', 'unix_socket' => ($this->targetDirs[5].'/tmp/mysql/mysql.sock'), 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4c5a4de215ca366a0a7b5744549c8fc1d196384747b5778a1dc8db58b9cedb36');
        return $instance;
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario-establecimiento');
        $i = new \Symfony\Component\Security\Http\AccessMap();
        $i->add($g, array(0 => 'ROLE_USUARIO'), NULL);
        $i->add($h, array(0 => 'ROLE_USUARIO_ESTABLECIMIENTO'), NULL);
